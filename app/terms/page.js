...
<h2>5. Licenses, laws and your state</h2>
  <p>The session script is written so the host coaches and the customer applies every product to her own nails. Whether that model satisfies your state, province or country&apos;s cosmetology rules is <b>your responsibility to confirm</b> with your own regulator or attorney. We provide the method and the script, not legal advice, and we make no promise that any activity is license-exempt where you operate.</p>
    ...
    <h2>6. Ownership</h2>
  <p>The library, the set designs, the codes, the book, the app, the generator and the Read My Nails name are the property of SeamlessLift LLC. A license doesn&apos;t transfer any of it.</p>
  <p>Anything you generate with the “Write a chapter” tool in your dashboard — chapters, phrases, sets, titles and blurbs — is ours too, the moment it&apos;s generated. It&apos;s our engine and our process doing the writing; typing a theme, an audience or notes into the box doesn&apos;t make the output yours. Approving a chapter licenses it to you the same way a library chapter is licensed under section 1: you can print it, sell it and keep using it for as long as we exist. But we own it outright, can publish it to every salon on the network, edit it or retire it, and owe you nothing further for it. (Chapters submitted through our creator program are different — see the terms at readmynails.com/creators for those.)</p>
  <p>Photos you post of hands printed at your location are yours; you give us permission to repost them with credit to your salon.</p>
