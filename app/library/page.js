      ...
      <main className="wrap">
        ...
        {community.length > 0 && (
          <section id="community" style={{ paddingBlock: 16 }}>
            <h2 style={{ marginBottom: 18 }}>Community <span className="muted" style={{ fontSize: '1rem', fontFamily: 'Nunito' }}>· chapters written by salons and creators, published to every kiosk</span></h2>
