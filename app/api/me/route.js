...
const salons = me.salons.map(s => ({
  ...
  return NextResponse.json({ email: me.email, isAdmin: me.isAdmin, salons, account, downloads, releases: rel, analytics, trending, partners, requests, ai: !!process.env.ANTHROPIC_API_KEY, payments: !!process.env.STRIPE_SECRET_KEY });
}
